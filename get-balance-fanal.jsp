...
String date =(String)session.getAttribute("datepicker");
String date1 =(String)session.getAttribute("datepicker1");
...
printWindow = window.open(  "Receipt.jsp","get-balance-fanal.jsp");
...
<p>&nbsp;</p>	</td>
	...
	<br/>
	<br/>
        <input type='button' value='print balance' onclick="printExternal()">
	<form id="form1" name="form1" method="post" action="">
	  ...
	  <table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          ...
          <td><div align="right"><strong>:</strong></div></td>
          <td>&nbsp;<font color="#FF0000"><%=bal%> KES. </font></td>
        </tr>
        <tr>
